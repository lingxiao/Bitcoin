...
\begin{itemize}
	\item install geth: \[bash <(curl -L https://install-geth.ethereum.org)\]
	...
	\item source: https://ethereum.stackexchange.com/questions/566/how-to-write-my-first-solidity-hello-world-smart-contract
		\end{itemize}
\end{itemize}
